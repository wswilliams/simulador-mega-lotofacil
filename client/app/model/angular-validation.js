...
(function () {
    ...
    function Provider() {
        ...
        this.getInjector = function (model) {
        ...
        this.reset = function (form) {
            ...
            jQuery('.form-group').removeClass('has-success').removeClass('has-error');
            jQuery('.glyphicon').removeClass("glyphicon-remove").removeClass('glyphicon-ok');
            jQuery('.msg').html('');
...
(function () {
    ...
    function Validator($injector) {
        ...
        var invalidFunc = function (element, validMessage, validation, scope, ctrl) {
            ...
            element.parent().addClass('has-feedback');
            element.next('.glyphicon').addClass("glyphicon-remove");
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                if (!scope.messageId) {
                    ...
                    element.after('<span aria-hidden="true" class="glyphicon form-control-feedback"></span>');
                }
