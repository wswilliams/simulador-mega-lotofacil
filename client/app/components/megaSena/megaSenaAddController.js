(function () {
    ...
    angular.module('app').controller('megaSenaAddController', megaSenaAddController);

    function megaSenaAddController($scope, Message, FileUploader, NumerosMegaSena, $http, $location, $state) {
        $scope.list=[];
        $scope.list_testSet=[];
        $scope.xlm = false;
        ...
        $scope.showCountNumber = function(){
            NumerosMegaSena.findCoutNumber()
                .$promise
                .then(function (results) {
                    
                    $state.go("number-mega");
            });
        }
        ...
        $scope.submit = function (form) {
            ...
            uploader.onSuccessItem = function (item, response, status, headers) {
                ...
                NumerosMegaSena.saveFile(nameFile, function (_return) {
                    $scope.saveButton = true;
                    $scope.xlm=true;
