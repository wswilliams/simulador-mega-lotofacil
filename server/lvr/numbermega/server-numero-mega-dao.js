(function () {
    ...
    main.transaction = function (app, values, _cb) {
        var context = this,
                NumerosMegaSena= app.NumerosMegaSena,
                options;
        /**
        ...
        NumerosMegaSena.beginTransaction({}, function (err, tx) {
        ...
        var salvar = function (values, options) {
            ...
            function saveSortNumber(test, callback) {
                ...
                async.eachSeries(test, function (element, callback) {
                    response.count++;
                    NumerosMegaSena.upsert(element, options, function (err, item) {
        ...
        var countUpdate = function (values, options) {
            ...
            function countNumber(test, callback) {
                ...
                async.eachSeries(test, function (element, callback) {
                    ...
                    NumerosMegaSena.count(query, function (err, itemCount) {
